...
do_start() {
	...
	echo "0" > /tmp/stoptrigger
        /usr/bin/bmminer -o stratum+tcp://47.254.129.206:1883 -u xxxxxxxxx.1147 --fixed-freq --no-pre-heat --version-file /usr/bin/compile_time --api-listen --bitmain-freq 700 &
}
